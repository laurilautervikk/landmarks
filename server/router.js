...
const landMarks = [{
    ...
    },
    {
        ...
        description: "The Statue of Liberty is a 305-foot (93-metre) statue located on Liberty Island in Upper New York Bay, off the coast of New York City.",
    },
    {
        id: 3,
        title: "Eiffel Tower",
        imageUrl: "https://www.swedishnomad.com/wp-content/images/2019/03/Paris.jpg",
        description: "The Eiffel Tower is a wrought iron tower that stands 1,063 ft (324 m) tall. It was designed for the Exposition Universelle, a world fair held in Paris in 1889.",
    },
    {
        id: 4,
        title: "Big Ben",
        imageUrl: "https://beautifulglobal.com/wp-content/uploads/2018/03/Big-Ben-2-1024x683.jpg",
        description: "Big Ben is a tower clock known for its accuracy and for its massive hour bell. Strictly speaking, the name refers only to the bell, which weighs 15.1 tons (13.7 metric tons).",
    },
    {
        id: 5,
        title: "Stonehenge",
    ...
    },
    {
        ...
        description: "Machu Picchu is a 15th-century Inca site located on a ridge between the Huayna Picchu and Machu Picchu mountains in Peru.",
    },
    {
        id: 8,
        title: "Grand Canyon",
        imageUrl: "https://westernnews.media.clients.ellingtoncms.com/img/photos/2021/03/23/HorseshoeBendGrandCanyon_pTg96X5.jpg",
        description: "Grand Canyon is considered one of the finest examples of arid-land erosion in the world. Incised by the Colorado River, the canyon is immense, averaging 4,000 feet deep for its entire 277 miles.",
    },
